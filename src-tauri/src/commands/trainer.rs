...
fn all_cheats() -> Vec<CheatDef> {
    vec![
        ...
        CheatDef {
            id: "fly_mode".into(),
            name: "Fly Mode".into(),
            description: "Toggle flight — press Z in-game to fly [Num 4]".into(),
        ...
        CheatDef {
            ...
            description: "Build and craft without resources [Num 5]".into(),
            category: "Creative".into(),
            enabled: false,
        },
        CheatDef {
            ...
            description: "Ignore cold, wet, and freezing [Num 6]".into(),
            category: "Survival".into(),
            enabled: false,
        },
        CheatDef {
            ...
            description: "Kill any creature in a single hit [Num 7]".into(),
        ...
        CheatDef {
            ...
            description: "Tools and weapons never break [Num 8]".into(),
            category: "Items".into(),
            enabled: false,
        },
        CheatDef {
            ...
            description: "Uncover the entire minimap on toggle [Alt+Num 0]".into(),
            category: "World".into(),
            enabled: false,
        },
        CheatDef {
            ...
            description: "Permanent rested bonus without comfort [Alt+Num 1]".into(),
            category: "Survival".into(),
            enabled: false,
        },
        CheatDef {
            ...
            description: "Eitr (magic resource) never depletes [Alt+Num 2]".into(),
            category: "Combat".into(),
            enabled: false,
        },
        CheatDef {
            ...
            description: "Tame any nearby creature instantly on toggle [Alt+Num 3]".into(),
            category: "World".into(),
            enabled: false,
        },
        CheatDef {
            id: "no_structure_damage".into(),
            name: "Invincible Structures".into(),
            description: "Player-built structures take no damage [Alt+Num 4]".into(),
            category: "Creative".into(),
            enabled: false,
        },
        CheatDef {
            id: "fast_skill_up".into(),
            name: "Fast Skill Up".into(),
            description: "Gain ~1 skill point per action instead of tiny increments [Alt+Num 5]".into(),
            category: "Survival".into(),
            enabled: false,
        },
    ]
